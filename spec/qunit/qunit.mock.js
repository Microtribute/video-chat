(function() {
  ...
  Expectation = (function() {
    ...
    Expectation.prototype.returns = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      $.each(args, __bind(function(i, el) {
        return this.returnsValues.push(el);
      }, this));
      return this;
    };
    return Expectation;
  ...
  expectCall = function(object, method, calls) {
    ...
    object[method] = function() {
      ...
      if (expectation.returnsValues.length > 0) {
        return expectation.returnsValues[expectation.callCount - 1];
      } else {
